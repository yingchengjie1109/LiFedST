...
class Trainer(object):
    ...
    def train_epoch(self, epoch):
        ...
        self.logger.info(
            '**********Train Epoch {}: MAE: {:.6f} RMSE: {:.6f} MAPE: {:.6f}'.format(epoch, mae, rmse, mape))
    ...
    def val_epoch_save(self, val_dataloader):
        ...
        torch.save(torch.Tensor([MAE_per_nodes, RMSE_per_nodes, MAPE_per_nodes]),
                   f'Error_{self.args.inter_dropout}.pth')