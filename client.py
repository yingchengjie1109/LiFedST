...
from model.LiFedST import LiFedST as Network
...
if __name__ == "__main__":
    ...
    args.add_argument('--active_mode', default='adptpolu', choices=['adptpolu']) #The remaining modes are yet to be refined.
    ...
    args.add_argument('--num_heads', default=config['model']['num_heads'], type=int)
    args.add_argument('--drop_out', default=config['model']['drop_out'], type=float)
    ...
    args.add_argument('--period_len', default=config['data']['period_len'], type=int)
    ...
    args.add_argument('--time_layers', default=config['model']['time_layers'], type=int)
    ...
    args.add_argument('--transformer_dim', default=config['model']['transformer_dim'], type=int)
